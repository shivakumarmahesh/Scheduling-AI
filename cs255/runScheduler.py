...
[tutorList, moduleList] = rw.readRequirements("ExampleProblems/Problem5.txt")
moduleLabList = moduleList
for i in range(0, len(moduleList)):
	moduleLabList.append(moduleList[i])
sch = scheduler.Scheduler(tutorList, moduleList, moduleLabList)
